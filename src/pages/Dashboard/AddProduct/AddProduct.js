...
const AddProduct = () => {
  ...
  const handleProduct = (data, e) => {
    ...
    uploadBytes(imgRef, image[0]).then((snapshot) => {
      getDownloadURL(snapshot.ref).then((url) => {
        ...
        fetch("https://rebook-server-nine.vercel.app/books", {
          method: "POST",
          headers: {
  ...
  return (
    <div className="card w-full shadow-2xl p-4">
      <h2 className="text-2xl font-bold text-center text-secondary my-2">
        Add a Book
      </h2>
      <form
        onSubmit={handleSubmit(handleProduct)}
        className="card-body bg-secondary/75 backdrop-blur-md rounded"
      >
        <div className="md:flex justify-between gap-2">
          ...
          <div className="form-control w-full">
            ...
            <input
              type="text"
              placeholder="Arif Azad, Shamsul Arefin etc."
              {...register("writer", {
        ...
        <div className="md:flex justify-between gap-2">
          ...
          <div className="form-control w-full">
            ...
            <input
              ...
              className="input input-bordered text-secondary"
            />
            {errors.timeOfPurchase && (
              <span className="text-error ml-1 mt-1">
                {errors.timeOfPurchase.message}
              </span>
            )}
          </div>
        </div>
            ...
            <div className="flex gap-3">
              <div className="flex items-center gap-2">
                <input
                  ...
                  checked
                />
                <label htmlFor="excellent" className="label-text text-primary">
                  Excellent
                </label>
              </div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="radio"
                />
                <label htmlFor="good" className="label-text text-primary">
                  Good
                </label>
              </div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="radio"
                />
                <label htmlFor="fair" className="label-text text-primary">
                  Fair
                </label>
              </div>
            </div>

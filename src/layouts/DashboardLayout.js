      ...
      <div className="drawer drawer-mobile">
        ...
        <div className="drawer-side shadow-2xl">
          <label
            ...
            className="drawer-overlay bg-secondary opacity-100"
          ></label>
          <ul className="menu p-4 w-80 text-secondary">
            {isAdminOrSeller === "buyer" && (
              <li>
            ...
            {isAdminOrSeller === "seller" && (
              <>
                ...
                <li>
                  <Link className="font-semibold" to="/dashboard/mybuyers">
                    My buyers
                  </Link>
                </li>
              </>
            ...
            {isAdminOrSeller === "admin" && (
              <>
                <li>
                  <Link className="font-semibold" to="/dashboard/sellers">
                    All Sellers
                  </Link>
                </li>
                <li>
                  <Link className="font-semibold" to="/dashboard/buyers">
                    All Buyers
                  </Link>
                </li>
                <li>
                  <Link className="font-semibold" to="/dashboard/reported">
                    Reported Items
                  </Link>
                </li>
              </>

...
const Register = () => {
  const { createUser, updateUserProfile, logOut, loading, setLoading } =
              ...
              <div className="form-control">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    checked
                  />
                  <label htmlFor="buyer" className="label-text text-primary">
                    Buyer
                  </label>
                  <input
                    type="radio"
                    ...
                    className="radio"
                  />
                  <label htmlFor="seller" className="label-text text-primary">
                    Seller
                  </label>
                </div>
              </div>
